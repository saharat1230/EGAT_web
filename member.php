  ...
  <div class='section content'>
    <div class="w3-container w3-center w3-animate-top">
      <?php
			...
			?>
      <?php
        printf('<h2><b> มีแอปพลิเคชั่นที่กำลังดำเนินการอยู่ <font color="#20B2AA"> %d </font> รายการ </b></h2> ',$total_data);
      ?>
            <div class="grid-container">
              <a href="app_member.php" class="myButton"><div><center>ติดตามการแอปพลิเคชั่น <br><br> <img src="img\03.png" width="150" height="150"></center></div></a>
              <a href="inventory_member.php" class="myButton"><div><center>ข้อมูล Application Inventory กทห-ห. <br><br> <img src="img\02.png" width="150" height="150"></center></div></a>
            </div>
          </div>
  </div>
</div>
